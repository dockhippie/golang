...
[
  ...
  pipeline.build(name, 'v1.13', 'v1.13', 'amd64'),
  pipeline.build(name, 'v1.13', 'v1.13', 'arm32v6'),
  pipeline.build(name, 'v1.13', 'v1.13', 'arm64v8'),
  pipeline.manifest('v1.13', 'v1.13', ['amd64', 'arm32v6', 'arm64v8']),
  ...
  pipeline.microbadger(['latest', '1.13', '1.12', '1.11', '1.10', '1.9', '1.8', '1.7', 'edge']),
  pipeline.downstream(['latest', '1.13', '1.12', '1.11', '1.10', '1.9', '1.8', '1.7', 'edge'], [
    'dockhippie/minio',
